...
{
    public class MetroTableHelper(LinkGenerator linkGenerator, IHttpContextAccessor httpContextAccessor) : MetroHTMLHelper<MetroTableHelper>
    {
        ...
        public MetroTableHelper WithSourceAction(string action)
            => SetDataset(DataAttrs.ExternalDataSourceLink, linkGenerator.GetPathByAction(httpContextAccessor.HttpContext, action));

        public MetroTableHelper WithSourceAction(string action, string controller)
            => SetDataset(DataAttrs.ExternalDataSourceLink, linkGenerator.GetPathByAction(httpContextAccessor.HttpContext, action, controller));
